...
const Profile: React.FC = () => {
  useEffect(() => {
    logAuditEvent('current-user', 'PAGE_VIEW', 'page:profile', 'success');
  }, []);

  const handleSignOut = (): void => {
    logAuditEvent('current-user', 'USER_SIGN_OUT', 'auth:signout', 'success');
  };
  ...
  return (
    <Layout>
      ...
      <div className='account'>
        ...
        <Link to='/' className='flex flex-v-center' onClick={handleSignOut}>
